...
# Keep the version-pinned lockfile supplied with the site. This also makes the
# Docker preview safe before a new checkout has been committed for the first time.
manage_gemfile_lock() {
